...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- tempat modal -->
        <div class="modal fade" id="modal_diagnosaAwal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content p-3">
                    <div class="d-flex flex-column justify-content-center text-center">
                        ...
                        <p>Diagnosa Awal Telah Berhasil <br>di Submit</p>
                        <button type="button" class="btn green-long" data-dismiss="modal">Oke</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="modal_diagnosaAkhir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content p-3">
                    <div class="d-flex flex-column justify-content-center text-center">
                        <span class="my-4">
                        ...
                        <p>Data Telah Berhasil <br>di Submit</p>
                        <button type="button" class="btn green-long" data-dismiss="modal">Oke</button>
                    </div>
                </div>
            </div>
