                            ...
                            <div class="col-lg-6 col-12">
                                <div class="row m-3 py-3 border-round">
                                    ...
                                    <div class="col-8 mt-3">
                                        ...
                                        <input class="form-control" type="text" name="PengkajianKeperawatan_1[FrekuensiNadi]" value="{{(!empty($dataPengkajian['PengkajianKeperawatan_1']['FrekuensiNadi']) ? $dataPengkajian['PengkajianKeperawatan_1']['FrekuensiNadi'] : '')}}" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-8 mt-3">
                                        ...
                                        <input class="form-control" type="text" name="PengkajianKeperawatan_1[FrekuensiNafas]" value="{{(!empty($dataPengkajian['PengkajianKeperawatan_1']['FrekuensiNafas']) ? $dataPengkajian['PengkajianKeperawatan_1']['FrekuensiNafas'] : '')}}" required>
                                        <div class="invalid-feedback">
