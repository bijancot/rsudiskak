...
@section('content')
    ...
    <div class="bg-greenishwhite">
        <div class="wrapper">
            <h3>Setting Hambatan Edukasi</h3>
                    ...
                    <table id="tbl" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="HambatanEdukasi">{{ $item->hambatanEdukasi }}</td>
    ...
    <div class="modal fade" id="modal_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ('HambatanEdukasiController@store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="hambatanEdukasi" class="col-form-label">Hambatan Edukasi :</label>
                        <input type="text" class="form-control" id="hambatanEdukasi" name="hambatanEdukasi">
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal_hapus-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ( 'HambatanEdukasiController@destroy', $item->id )}}" method="POST">
                @method('delete')
                @csrf
                <div class="modal-body">
                    <p>Apa anda yakin ingin menghapus data <code>{{ $item->hambatanEdukasi }}</code> ?</p>
                </div>
                <div class="modal-footer">
