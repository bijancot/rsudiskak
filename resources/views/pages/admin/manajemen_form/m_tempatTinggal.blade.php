                    ...
                    <table id="tbl" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="TempatTinggal">{{ $item->tempatTinggal }}</td>
    ...
    <div class="modal fade" id="modal_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ('TempatTinggalController@store')}}" method="POST">
                @csrf
    ...
    <div class="modal fade" id="modal_hapus-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ( 'TempatTinggalController@destroy', $item->id )}}" method="POST">
                @method('delete')
                @csrf
                <div class="modal-body">
                    <p>Apa anda yakin ingin menghapus data <code>{{ $item->tempatTinggal }}</code> ?</p>
                </div>
                <div class="modal-footer">
