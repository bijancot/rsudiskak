                    ...
                    <table id="tbl" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="NilaiAnut">{{ $item->nilaiAnut }}</td>
    ...
    <div class="modal fade" id="modal_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ('NilaiAnutController@store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nilaiAnut" class="col-form-label">Nilai - nilai yang dianut :</label>
                        <input type="text" class="form-control" id="nilaiAnut" name="nilaiAnut">
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal_hapus-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ( 'NilaiAnutController@destroy', $item->id )}}" method="POST">
                @method('delete')
                @csrf
                <div class="modal-body">
                    <p>Apa anda yakin ingin menghapus data <code>{{ $item->nilaiAnut }}</code> ?</p>
                </div>
                <div class="modal-footer">
