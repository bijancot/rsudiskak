                ...
                <div class="card">
                    ...
                    <table id="tbl" class="table table-striped ">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>KdDiagnosaTindakan</th>
                                <th>DiagnosaTindakan</th>
                                <th>KodeDiagnosaT</th>
                                {{-- <th>Action</th> --}}
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @foreach ($iCD09 as $item)
                            <tr>
                                <td data-label="No">{{ $loop->iteration }}</td>
                                <td data-label="KdDiagnosaTindakan">{{ $item->KdDiagnosaTindakan }}</td>
                                <td data-label="DiagnosaTindakan">{{ $item->DiagnosaTindakan }}</td>
                                <td data-label="KodeDiagnosaT">{{ $item['KodeDiagnosaT'] }}</td>
    ...
    <div class="modal fade" id="modal_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="{{ action ('ICD09Controller@store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <p> Anda akan menambahkan data ICD 09 ?</p>
                </div>
